...
// Intergral: the theme-switch and dev-tooling preference actions, along with the
// invite-user action, are removed from the command palette — theming and user management
// are handled by the surrounding FusionReactor Cloud shell.
