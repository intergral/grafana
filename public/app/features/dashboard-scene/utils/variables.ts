      ...
      try {
        ...
        if (v.type === 'adhoc') {
          ...
          return new AdHocFiltersVariable({
            ...
            hide: v.hide,
            datasource: resolvedDs?.uid ? { type: resolvedDs.type, uid: resolvedDs.uid } : v.datasource,
            applyMode: 'auto',
            filters: v.filters ?? [],
...
export function createSceneVariableFromVariableModel(variable: TypedVariableModel): SceneVariable {
  ...
  if (variable.type === 'adhoc') {
    ...
    const datasource = resolvedDs?.uid ? { type: resolvedDs.type, uid: resolvedDs.uid } : variable.datasource;
