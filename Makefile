...
test-go-integration: ## Run integration tests for backend with flags.
	...
	$(GO) test $(GO_RACE_FLAG) $(GO_TEST_FLAGS) -count=1 -run "^TestIntegration" -skip "TestIntegrationProvisioning|TestIntegrationSimpleQuery|TestIntegrationPlaylist|TestIntegrationIdentity" -covermode=atomic -coverprofile=$(GO_INTEGRATION_COVER_PROFILE) -timeout=5m \
