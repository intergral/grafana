...
test-go-integration: ## Run integration tests for backend with flags.
	...
	$(GO) test $(GO_RACE_FLAG) $(GO_TEST_FLAGS) -count=1 -run "^TestIntegration" -skip "TestIntegrationProvisioning|TestIntegrationSimpleQuery|TestIntegrationPlaylist|TestIntegrationIdentity|TestIntegrationAccessControl|TestIntegrationCRUD|TestIntegrationDataConsistency|TestIntegrationFoldersApp|TestIntegrationInUseMetadata|TestIntegrationOptimisticConcurrency|TestIntegrationPatch|TestIntegrationReferentialIntegrity|TestIntegrationResourceIdentifier|TestIntegrationResourcePermissions|TestIntegrationTimeIntervalAccessControl|TestIntegrationTimeIntervalListSelector|TestIntegrationTimeIntervalOptimisticConcurrency|TestIntegrationTimeIntervalPatch|TestIntegrationTimeIntervalProvisioning|TestIntegrationTimeIntervalReferentialIntegrity|TestIntegrationTimeIntervalValidation|TestIntegrationValidation|TestIntegrationListSelector|TestIntegrationReceiverListSelector" -covermode=atomic -coverprofile=$(GO_INTEGRATION_COVER_PROFILE) -timeout=5m \
